...
| 2 | Buildroot baseline | Build and boot public Milk-V Duo SDK v2 image | next |
| 3 | Board ownership | UART, U-Boot/recovery, flash/rootfs access on target boards | blocked by hardware delivery |
...
- **Tuya THP23-ZB-X**: 128MB comparison / liberation node.
