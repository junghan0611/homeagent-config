...
- (4) **[Phase 2 열림] EZSP 13 내 7.4↔7.5 frame 델타**: 로컬 GSDK 4.5.0=7.5.1만 보유 → 7.4.2 `ezsp-enum.h`(또는 SiLabs UG100 EZSP ref) 확보 후 frame-ID diff. host 직접구동(RexBee 대체 경로) 착수 시 필요. 코어 커맨드는 `ezsp.c` VERSION 협상으로 상호운용 안전(§5.5 Q4).
